...
console.log(e)
    ...
    async voteYes(_airline) {
        try{
        await this._vote(_airline, true).send({ from: this._address })
        }catch(e){
            console.log(e)
    ...
    async voteNo(_airline) {
        try{
            await this._vote(_airline, false).send({ from: this._address })
            }catch(e){
                console.log(e)
                throw new Error('error during voting')
            }
